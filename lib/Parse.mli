...
(**
    Functions for parsing fga programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a fga program from a string into a typed OCaml CST.
...
(** Parse a fga program from a file into a typed OCaml CST.
